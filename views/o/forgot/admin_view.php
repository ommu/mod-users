...
<div class="dialog-content">
	<?php $this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
			...
			array(
				'name'=>'forgot_date',
				'value'=>!in_array($model->forgot_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? Utility::dateFormat($model->forgot_date, true) : '-',
			),
			array(
				'name'=>'forgot_ip',
			...
			array(
				'name'=>'expired_date',
				'value'=>!in_array($model->expired_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? Utility::dateFormat($model->expired_date, true) : '-',
			),
			array(
				'name'=>'modified_date',
