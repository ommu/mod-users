	...
	<?php $this->widget('zii.widgets.CDetailView', array(
		...
		'attributes'=>array(
			...
			*/
			...
			array(
				'name'=>'lastlogin_date',
				'value'=>!in_array($model->lastlogin_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? Utility::dateFormat($model->lastlogin_date, true) : '-',
			),
			array(
				'name'=>'lastlogin_ip',
			...
			array(
				'name'=>'update_date',
				'value'=>!in_array($model->update_date, array('0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00')) ? Utility::dateFormat($model->update_date, true) : '-',
			),
			array(
				'name'=>'update_ip',
