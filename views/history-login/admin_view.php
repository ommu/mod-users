...
<?php echo DetailView::widget([
	...
	'attributes' => [
		...
		[
			...
			'value' => !in_array($model->lastlogin_date, ['0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 00:00:00','-0001-11-30 00:00:00']) ? Yii::$app->formatter->format($model->lastlogin_date, 'datetime') : '-',
		],
		'lastlogin_ip',
		'lastlogin_from',
	],
