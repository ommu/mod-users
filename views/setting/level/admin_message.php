...
$message_limit_inbox = $form->field($model, 'message_limit[inbox]', ['template' => '{beginWrapper}{input}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-4 col-xs-6 col-6 offset-sm-3', 'hint'=>'col-md-3 col-sm-5 col-xs-6 col-6'], 'options' => ['tag' => null]])
...
<?php $message_limit_outbox = $form->field($model, 'message_limit[outbox]', ['template' => '{beginWrapper}{input}{endWrapper}{hint}', 'horizontalCssClasses' => ['wrapper'=>'col-md-3 col-sm-4 col-xs-6 col-6 offset-sm-3', 'hint'=>'col-md-3 col-sm-5 col-xs-6 col-6'], 'options' => ['tag' => null]])
	->dropDownList($messageLimit, ['prompt' => ''])
	->label($model->getAttributeLabel('message_limit[outbox]'))
	->hint(Yii::t('app', 'conversations in outbox folder.')); ?>

<?php echo $form->field($model, 'message_limit', ['template' => '{label}{hint}'.$message_limit_inbox.$message_limit_outbox.'{error}', 'horizontalCssClasses' => ['hint'=>'col-md-6 col-sm-9 col-xs-12 col-12', 'error'=>'col-md-6 col-sm-9 col-xs-12 col-12 offset-sm-3']])
	->dropDownList($messageLimit, ['prompt' => ''])
