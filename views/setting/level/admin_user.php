...
echo $form->field($model, 'profile_block', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'assignment_roles', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->checkboxList($assignments)
	->label($model->getAttributeLabel('assignment_roles'))
	->hint(Yii::t('app', '')); ?>

<?php $profileSearch = UserLevel::getProfileSearch();
echo $form->field($model, 'profile_search', ['template' => '{label}{beginWrapper}<div class="h5">'.$model->getAttributeLabel('profile_search').'</div>{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_privacy', ['template' => '{beginWrapper}<div class="h5">'.$model->getAttributeLabel('profile_privacy').'</div>{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12 col-sm-offset-3']])
...
echo $form->field($model, 'profile_comments', ['template' => '{beginWrapper}<div class="h5">'.$model->getAttributeLabel('profile_comments').'</div>{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12 col-sm-offset-3']])
...
echo $form->field($model, 'photo_allow', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'photo_size', ['template' => '{beginWrapper}{hint}'.$photo_size_width.$photo_size_height.'{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12 col-sm-offset-3']])
	->label($model->getAttributeLabel('photo_size'))
...
<?php echo $form->field($model, 'photo_exts', ['horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
	->textInput()
...
echo $form->field($model, 'profile_style', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_style_sample', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_status', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_invisible', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_views', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_change', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
...
echo $form->field($model, 'profile_delete', ['template' => '{label}{beginWrapper}{hint}{input}{error}{endWrapper}', 'horizontalCssClasses' => ['wrapper'=>'col-sm-9 col-xs-12 col-12']])
