...
$this->params['menu']['content'] = [
	['label' => Yii::t('app', 'Back To Subscribes'), 'url' => Url::to(['subscribe/index']), 'icon' => 'table'],
];
			...
			array_push($columnData, [
				...
				'buttons' => [
					'view' => function ($url, $model, $key) {
						...
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url, ['title' => Yii::t('app', 'View User Newsletter History')]);
					},
