...
echo $form->field($model, 'profile_block', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', 'If set to "yes", users can block other users from sending them private messages, requesting their friendship, and viewing their profile. This helps fight spam and network abuse.').'</span>{input}{error}</div>'])
...
<div class="form-group">
	...
	<div class="col-md-6 col-sm-6 col-xs-12">
		...
		<?php echo $form->field($model, 'photo_size[height]', ['template' => '<div class="col-md-5 col-sm-5">'.Yii::t('app', 'Maximum Height:<br />(in pixels, between 1 and 999)').'</div><div class="col-md-7 col-sm-7">{input}{error}</div>'])
			->textInput(['type' => 'number','maxlength' => true])
			->label($model->getAttributeLabel('photo_size'), ['class'=>'control-label col-md-3 col-sm-3 col-xs-12']); ?>
		...
		echo $form->field($model, 'photo_exts', ['template' => '<span class="small-px mb-10">'.Yii::t('app', 'What file types do you want to allow for user photos (gif, jpg, jpeg, or png)? Separate file types with commas, i.e. jpg, jpeg, gif, png').'</span>{input}{error}'])
			->textInput()
...
echo $form->field($model, 'profile_status', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', 'Enable this feature if you want to allow users to show their "status" on their profile. By updating their status, users can tell others what they are up to, what\'s on their minds, etc.').'</span>{input}{error}</div>'])
...
echo $form->field($model, 'profile_invisible', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', 'Enable this feature if you want to allow users to go "invisible" (not be displayed in the online users list even if they are online).').'</span>{input}{error}</div>'])
...
echo $form->field($model, 'profile_views', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', '
...
echo $form->field($model, 'profile_change', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', '
...
echo $form->field($model, 'profile_delete', ['template' => '{label}<div class="col-md-6 col-sm-6 col-xs-12"><span class="small-px">'.Yii::t('app', 'Enable this feature if you would like to allow your users to delete their account manually.').'</span>{input}{error}</div>'])
