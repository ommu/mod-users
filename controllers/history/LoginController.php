...
class LoginController extends Controller
{
	...
	public function actionManage($user=null) 
	{
		...
		$UserHistoryLogin = Yii::app()->getRequest()->getParam('UserHistoryLogin');
		if($UserHistoryLogin)
			$model->attributes=$UserHistoryLogin;

		$columns = $model->getGridColumn($this->gridColumnTemp());

		$pageTitle = Yii::t('phrase', 'User History Logins');
		if($user != null) {
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Detail History Login: {user_id}', array('{user_id}'=>$model->user->displayname));
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if($model->delete()) {
				echo CJSON::encode(array(
					...
					'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'User history login success deleted.').'</strong></div>',
				));
			}
			Yii::app()->end();
		}
		...
		$this->pageTitle = Yii::t('phrase', 'Delete History Login: {user_id}', array('{user_id}'=>$model->user->displayname));
		$this->pageDescription = '';
		$this->pageMeta = '';
