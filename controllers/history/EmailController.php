...
class EmailController extends Controller
{
	...
	public function actionManage($user=null) 
	{
		...
		$UserHistoryEmail = Yii::app()->getRequest()->getParam('UserHistoryEmail');
		if($UserHistoryEmail)
			$model->attributes=$UserHistoryEmail;

		$columns = $model->getGridColumn($this->gridColumnTemp());

		$pageTitle = Yii::t('phrase', 'User History Emails');
		if($user != null) {
	...
	public function actionView($id) 
	{
		...
		$this->pageTitle = Yii::t('phrase', 'Detail History Email: {user_id}', array('{user_id}'=>$model->user->displayname));
		$this->pageDescription = '';
		$this->pageMeta = '';
	...
	public function actionDelete($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			if($model->delete()) {
				echo CJSON::encode(array(
					...
					'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'User history email success deleted.').'</strong></div>',
				));
			}
			Yii::app()->end();
		}
		...
		$this->pageTitle = Yii::t('phrase', 'Delete History Email: {user_id}', array('{user_id}'=>$model->user->displayname));
		$this->pageDescription = '';
		$this->pageMeta = '';
