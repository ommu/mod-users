...
class UserInvites extends \app\components\ActiveRecord
{
	...
	public function init() 
	{
		...
		$this->templateColumns['invite_date'] = [
			...
			'value' => function($model, $key, $index, $column) {
				return !in_array($model->invite_date, ['0000-00-00 00:00:00','1970-01-01 00:00:00','0002-12-02 07:07:12','-0001-11-30 00:00:00']) ? Yii::$app->formatter->format($model->invite_date, 'date'/*datetime*/) : '-';
			},
			'format'	=> 'html',
		];
