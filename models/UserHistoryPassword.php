...
class UserHistoryPassword extends OActiveRecord
{
	use GridViewTrait;
	...
	public function tableName()
	{
		...
		return $matches[1].'.ommu_user_history_password';
	}
	...
	public function rules()
	{
		...
		return array(
			array('password, update_date', 'required'),
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('UserHistoryPassword_sort'))
