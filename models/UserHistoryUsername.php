...
class UserHistoryUsername extends OActiveRecord
{
	use GridViewTrait;
	...
	public function tableName()
	{
		...
		return $matches[1].'.ommu_user_history_username';
	}
	...
	public function rules()
	{
		...
		return array(
			array('username, update_date', 'required'),
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('UserHistoryUsername_sort'))
