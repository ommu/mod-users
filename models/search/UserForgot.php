 ...
 * version: 0.0.1
 *
 * UserForgot represents the model behind the search form about `app\coremodules\user\models\UserForgot`.
 *
...
use app\coremodules\user\models\UserForgot as UserForgotModel;
