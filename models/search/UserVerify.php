 ...
 * UserVerify
 *
 * UserVerify represents the model behind the search form about `app\modules\user\models\UserVerify`.
 *
...
use app\modules\user\models\UserVerify as UserVerifyModel;
