 ...
 * version: 0.0.1
 *
 * UserLevel represents the model behind the search form about `app\coremodules\user\models\UserLevel`.
 *
...
use app\coremodules\user\models\UserLevel as UserLevelModel;
