...
<div class="account">
	<?php //begin.Photo ?>
	<a off_address="" id="uplaod-image" class="photo" href="<?php echo Yii::app()->createUrl('users/o/photo/ajaxadd', array('type'=>'admin'));?>" title="<?php echo Yii::t('phrase', 'Change Photo').': '.Yii::app()->user->displayname;?>"><img src="<?php echo $images;?>" alt="<?php echo $model->photo_id != 0 ? Yii::app()->user->displayname : 'Ommu Platform';?>"/></a>
	<div class="info">
