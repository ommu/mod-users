...
<fieldset>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'verify_date'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'verify_date'); ?>
			<?php echo $form->error($model,'verify_date'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'verify_ip'); ?>
		<div class="desc">
			<?php echo $form->textField($model,'verify_ip',array('size'=>20,'maxlength'=>20)); ?>
			<?php echo $form->error($model,'verify_ip'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>
